...
python -u /zhome/f9/2/183623/DEEP_BIOMED/inference/inference.py --model_type pretrained_unet --data_path ./covid_data.nosync/crop_data/train/image_256_512.npy --wandb_runtime 2023-12-09_23-51
